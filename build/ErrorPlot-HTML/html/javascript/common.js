...
function cons_input (i) {
  ...
  el_in = document.getElementById (id_in);
    ...
    div = '<div name="' +id_in+ '" id="' +id_in+ '" class="IFF">'
        ...
        + escape(el_in.firstChild.nodeValue)+ '"><img src="../images/mathematicaImages/mail.gif" width="39" height="22" border="0"/></a></td><td align="right">'
...
function input(i) {
  ...
  if (!el_in) {
    ...
    // We've already downloaded/constructed the layer
...
function open_all () {
  open_ES ();
  var clss = ["ELMS", "EXTS", "IES", "MAS", "NIS", "NS", "OS", "PES", "RDS", "RLS", "RTS", "SAS", "TMAS", "TOC", "TRLS", "TS"];
...
function toggleExampleSubsection(idn) {
  ...
  if (divElement.className == 'ESSC') {
    ...
    imgElement.src = '../images/mathematicaImages/openGroup.gif'
  } else {
    divElement.className = 'ESSC';
    imgElement.src = '../images/mathematicaImages/closedGroup.gif'
  }
}
...
function toggleSection(idn) {
  ...
  if (divElement.className == idn+'C') {
    ...
    imgElement.src = '../images/mathematicaImages/openSectionGroup.gif'
  } else {
    divElement.className = idn+'C'; 
    imgElement.src = '../images/mathematicaImages/closedSectionGroup.gif' } 
} 
